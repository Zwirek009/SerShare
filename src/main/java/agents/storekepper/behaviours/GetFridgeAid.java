...
public class GetFridgeAid extends CyclicBehaviour {
    public GetFridgeAid(StorekeeperAgent agent) {
        super(agent);
    }

    public void action() {
        ACLMessage msg = myAgent.receive(MessageTemplate.MatchConversationId("hello-from-fridge"));
        ...
        if (msg != null) {
            ...
            if(msg.getPerformative() == ACLMessage.NOT_UNDERSTOOD) {
                ...
                getAgent().addNewFridge(msg.getSender());

                LOGGER.log(Level.INFO, "Get new fridge " + msg.getSender());
            }
